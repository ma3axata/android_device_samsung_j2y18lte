 ...
 * {@hide}
 */
public class msm8937RIL extends RIL {
    ...
    public msm8937RIL(Context context, int networkMode, int cdmaSubscription) {
        this(context, networkMode, cdmaSubscription, null);
    }

    public msm8937RIL(Context context, int preferredNetworkType,
